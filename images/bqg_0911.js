...
function login(){
document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><div class=\"ywtop_sethome\"><a href=\"/zhuomian.php\">将酷酷中文快捷键下载到桌面</a></div>");
document.writeln("		<div class=\"ywtop_addfavorite\"><a href=\"javascript:window.external.addFavorite(\'http://www.kukuzw.com\',\'奇迹小锁_书友最值得收藏的网络小说阅读网\')\">收藏酷酷中文</a></div>");
...
document.writeln("<p>Copyright &copy; 2012 酷酷中文 All Rights Reserved.</p>");
...
function bqg_panel(){
document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"http://www.baidu.com/s\" id=\"sform\" target=\"_blank\"><input type=\"text\" value=\"可搜书名和作者，请您少字也别输错字。\" name=\"wd\" class=\"search\" id=\"searchkey\" onclick=\"ttt()\" baiduSug=\"2\" /><input name=\"ct\" type=\"hidden\" value=\"2097152\" /><input name=\"si\" type=\"hidden\" value=\"kukuzw.com\" /><input name=\"sts\" type=\"hidden\" value=\"kukuzw.com\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>"); 
document.writeln("<div class=\"userpanel\">&nbsp;<font color=\"red\">留言：</font><a target=\"_blank\" href=\"http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=youjian@qq.com\">通过邮件</a>、<a href=\"/newmessage.php?tosys=1\" >站内短信</a><br /><a target=\"_blank\" href=\"/jifen.html\">积分规则</a>&nbsp;&nbsp;<a target=\"_blank\" href=\"/dns.html\">解决跳到别的站</a></div>");
}
function mark(){
