...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?37073ea9163ef552001872d070521fc3";
...
function login(){
document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><div class=\"ywtop_sethome\"><a href=\"/#\">将人人小说网快捷键下载到桌面</a></div>");
document.writeln("		<div class=\"ywtop_addfavorite\"><a href=\"javascript:window.external.addFavorite(\'http://www.agxs.net\',\'人人小说网_书友最值得收藏的网络小说阅读网\')\">收藏人人小说网</a></div>");
document.write('<div class="nri">');
if(jieqiUserId != 0 && jieqiUserName != '' && (document.cookie.indexOf('PHPSESSID') != -1 || jieqiUserPassword != '')){
  if(jieqiUserVip == 1) jieqiUserVipName='<span class="hottext">至尊VIP-</span>';
  document.write('Hi,<a href="/userdetail.php?uid='+jieqiUserId+'" rel="external nofollow" target="_top">'+jieqiUserName+'</a>&nbsp;&nbsp;<a href="/modules/article/bookcase.php?uid='+jieqiUserId+'" rel="external nofollow" target="_top">我的书架</a>');
  if(jieqiNewMessage > 0){
	  document.write(' | <a href="/message.php?uid='+jieqiUserId+'&box=inbox" rel="external nofollow" target="_top"><span class=\"hottext\">您有短信</span></a>');
  }else{
	  document.write(' | <a href="/message.php?uid='+jieqiUserId+'&box=inbox" rel="external nofollow" target="_top">查看短信</a>');
  }
  document.write(' | <a href="/userdetail.php?uid='+jieqiUserId+'" rel="external nofollow" target="_top">查看资料</a> | <a href="/logout.php" rel="external nofollow" target="_self">退出登录</a>&nbsp;');
}else{
  var jumpurl="";
  ...
  document.write('<div class="frii"><input type="submit" class="int" value=" " /></div><div class="ccc"><div class="txtt"><a href="/getpass.php" rel="external nofollow">忘记密码</a></div><div class="txtt"><a href="/register.php" rel="external nofollow">用户注册</a></div></div></form>');
}
...
document.writeln("<p>Copyright &copy; 2012 人人小说网 All Rights Reserved.</p>");
